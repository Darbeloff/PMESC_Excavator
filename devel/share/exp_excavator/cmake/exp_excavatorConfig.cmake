...
if("TRUE" STREQUAL "TRUE")
  set(exp_excavator_SOURCE_PREFIX /home/weitung/excavation_ws/src/exp_excavator)
  set(exp_excavator_DEVEL_PREFIX /home/weitung/excavation_ws/devel)
  ...
  set(exp_excavator_INSTALL_PREFIX /home/weitung/excavation_ws/install)
...
if(NOT "/home/weitung/excavation_ws/devel/include " STREQUAL " ")
  set(exp_excavator_INCLUDE_DIRS "")
  set(_include_dirs "/home/weitung/excavation_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'exp_excavator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'yutak <yutak@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'exp_excavator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/weitung/excavation_ws/src/exp_excavator/${idir}'.  Ask the maintainer 'yutak <yutak@todo.todo>' to fix it.")
    endif()
...
set(exp_excavator_EXPORTED_TARGETS "exp_excavator_generate_messages_cpp;exp_excavator_generate_messages_lisp;exp_excavator_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${exp_excavator_dep}_FOUND)
      find_package(${exp_excavator_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${exp_excavator_dep} REQUIRED ${depend_list})
  endif()
