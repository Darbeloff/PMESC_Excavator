...
echo_and_run cd "/home/weitung/excavation_ws/src/rocon_devices/rocon_device_tools/rocon_iot_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/weitung/excavation_ws/src/rocon_devices/rocon_device_tools/rocon_iot_bridge/setup.py" \
    build --build-base "/home/weitung/excavation_ws/build/rocon_devices/rocon_device_tools/rocon_iot_bridge" \
    install \
    $DESTDIR_ARG \
